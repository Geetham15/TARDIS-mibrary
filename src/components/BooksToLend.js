...
const BooksToLend = ({ selectedBook }) => {
      ...
      <form>
        <table>
          <tbody>
            ...
            <tr>
              <td><label htmlFor='Book owner'>Book Owner</label></td>
              <td><input id='bookOwner'
                name='bookOwner'
                type='text'
            ...
            <tr>
              <td><label htmlFor='bookBorrower'>Book Borrower</label></td>
              <td><input id='bookBorrower'
                name='bookBorrower'
                type='text'
            ...
            <tr>
              <td><label htmlFor='dateBorrowed'>Date Borrowed</label></td>
              <td><input type="date" name='dateBorrowed' value={currentDateBorrowed}
                onChange={e => setDateBorrowed(e.target.value)} />
              </td>
            </tr>
            <tr>
              <td><label htmlFor='dueDateForReturn'>Due Date</label></td>
              <td><input type="date" name='dueDateForReturn'
                value={dateDueForReturn} onChange={e => setDateDueForReturn(e.target.value)} />
              </td>
            </tr>
            <tr>
              <td><label htmlFor="bookStatus">BookStatus</label></td>
              <td><select name="bookStatus" value={bookStatus} onChange={e => setBookStatus(e.target.value)}>
          ...
          <button className='btn' onClick={bookOutOnLoan}>Checkout</button>
        </table>
      </form>
    </div>
  )
